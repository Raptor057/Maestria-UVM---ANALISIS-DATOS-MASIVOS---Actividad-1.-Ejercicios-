...
Salida
    ...
    Nombre completo: Rogelio Arriaga
...
Salida
    ...
    Área del círculo: 2827.43 metros cuadrados
    
    Circunferencia del círculo: 188.50 metros
    
    Introduce el radio del círculo (en metros): 10
    
    El área del círculo con radio 10.0 es: 314.16 metros cuadrados
...
Salida
    ...
    Diccionario de perro: {'nombre': 'Max', 'color': 'Marrón', 'raza': 'Labrador', 'patas': 4, 'edad': 5}
    
    Diccionario de estudiante: {'nombre': 'Juan', 'apellido': 'Pérez', 'sexo': 'Masculino', 'edad': 26, 'estado_civil': 'Soltero', 'habilidades': ['Python', 'SQL'], 'pais': 'México', 'ciudad': 'Ciudad de México', 'direccion': 'Calle Falsa 123'}
    
    Longitud del diccionario de estudiante: 9
    
    Habilidades: ['Python', 'SQL']
    
    Tipo de datos de habilidades: <class  'list'>
    
    Habilidades modificadas: ['Python', 'SQL', 'Java', 'Docker']
    
    Claves del diccionario de estudiante: ['nombre', 'apellido', 'sexo', 'edad', 'estado_civil', 'habilidades', 'pais', 'ciudad', 'direccion']
    
    Valores del diccionario de estudiante: ['Juan', 'Pérez', 'Masculino', 26, 'Soltero', ['Python', 'SQL', 'Java', 'Docker'], 'México', 'Ciudad de México', 'Calle Falsa 123']
    
    Diccionario como lista de tuplas: [('nombre', 'Juan'), ('apellido', 'Pérez'), ('sexo', 'Masculino'), ('edad', 26), ('estado_civil', 'Soltero'), ('habilidades', ['Python', 'SQL', 'Java', 'Docker']), ('pais', 'México'), ('ciudad', 'Ciudad de México'), ('direccion', 'Calle Falsa 123')]
    
    Diccionario de estudiante después de eliminar 'estado_civil': {'nombre': 'Juan', 'apellido': 'Pérez', 'sexo': 'Masculino', 'edad': 26, 'habilidades': ['Python', 'SQL', 'Java', 'Docker'], 'pais': 'México', 'ciudad': 'Ciudad de México', 'direccion': 'Calle Falsa 123'}
    
    El diccionario de perro ha sido eliminado.
...
Salida
    ...
    Área de un círculo con radio 7: 153.93804002589985
    
    Suma de 1, 2, 3: 6
    
    Prueba con un elemento no numérico: Todos los elementos deben ser números.
    
    Convertir 25°C a °F: 77.0
    
    Soluciones de x² - 4x + 4 = 0: Tiene una solución: x = 2.0
    
    Soluciones de x² + 2x + 1 = 0: Tiene una solución: x = -1.0
    
    Soluciones de x² + x + 1 = 0: No tiene soluciones reales.
    
    Elementos de la lista ['Python', 'C++', 'Java']:
